...
//* by Leandro Baca
//******************************************************************************
//* NOTE: This version contains Python-specific semantic predicates.
//******************************************************************************
...
API_COMMENT : '/**' ~[/] .*? '*/' {(not re_3_star.match(self.text))}? -> channel(API_COMMENTS) ;
...
LINE_COMMENT : R E M (A R K)? .*? ';' {re_rem.match(self.text)}? -> channel(COMMENTS) ;
